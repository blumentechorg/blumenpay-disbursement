...
// const FloatingSearchContainer = ({ onSelectAll }) => {
//   // Existing search, menu, modal state...
//   const [isMenuOpen, setIsMenuOpen] = useState(false);
//   const [isAllTransactions, setIsAllTransactions] = useState(false);
//   const [searchText, setSearchText] = useState("");
//   const [isModalOpen, setIsModalOpen] = useState(false);
...
//         // Optionally clear form data or trigger a refresh
//       } else {
...
//                     }
//                     className="w-full px-4 py-2 border rounded-md text-xs"
//                     required
//                   />
//                 </div>
//                 <div className="mb-4">
...
//                     onChange={(e) =>
//                       setBusinessData({ ...businessData, logo: e.target.value })
//                     }
//                     className="w-full px-4 py-2 border rounded-md text-xs"
//                   />
//                 </div>
...
//                     <div
//                       className="w-20 h-20 border rounded-md flex items-center justify-center overflow-hidden cursor-pointer hover:opacity-90 transition"
...
//                       type="button"
//                       onClick={handleLogoClick}
//                       className="mb-2 bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600 focus:outline-none"
//                     >
//                       Upload Logo
//                     </button>
//                     <input
