...
//     >
//       {modalContent.status.label === "Failed" ? (
//         <div
...
//   // Use modalContent.createdAt instead of modalContent.date if that’s your table field
//   const transactionDate = modalContent.createdAt || modalContent.date;

//   // Check the status using the .label property
//   const isFailed =
//     modalContent.status && modalContent.status.label === "Failed";
...
//                   <p className="text-gray-700 text-xs font-medium">
//                     <span className="font-light">Date:</span>{" "}
//                     <span className="uppercase">{transactionDate}</span>
//                   </p>
//                   <p className="text-gray-700 text-xs font-medium">
//                     <span className="font-light">Service Provider:</span>{" "}
...
//                     <span className="font-light">Status:</span>{" "}
//                     <span className="text-red-600">
//                       {modalContent.status && modalContent.status.label}
//                     </span>
//                   </p>
//                 </div>
//               </div>
...
const TransactionModal = ({ modalContent, onClose }) => {
  ...
  // Use the createdAt field if available; otherwise fallback to date.
  const transactionDate = modalContent.createdAt || modalContent.date;
  const statusLabel = modalContent.status?.label || "";

  // Determine the icon based on status using a switch condition.
      ...
      >
        ...
        >
          ...
          <div className="mt-5 px-4">
            ...
            <div className="p-4 bg-gray-50 rounded-md border">
              {/* Icon determined via switch condition */}
          ...
          <div className="mt-5 px-4">
            ...
            <div className="p-4 bg-gray-50 rounded-md border space-y-3">
              ...
              <p className="text-gray-700 text-xs">
                <span className="font-light">Email:</span>{" "}
                <span className="font-medium uppercase">johndoe@gmail.com</span>
              </p>
              <p className="text-gray-700 text-xs">
                <span className="font-light">Phone:</span>{" "}
                <span className="font-medium uppercase">09031754067</span>
